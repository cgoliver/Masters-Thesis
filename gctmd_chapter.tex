...
Given that NMR reports transitions between extended and collapsed conformations, we hypothesize that a similar motion is driving the displacement observed in the RMSD computations of the YD mutant. We use two metrics to measure the compactness of the polypeptides: radius of gyration and translational diffusion coefficient.
