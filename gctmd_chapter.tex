...
\begin{figure}
\centering     %%% not \center
\subfigure[Figure A]{\label{fig:a}\includegraphics[width=0.49\textwidth]{figures/wt_hist.pdf}}
\subfigure[Figure B]{\label{fig:b}\includegraphics[width=0.49\textwidth]{figures/yd_2gauss.pdf}}
\subfigure[Figure C]{\label{fig:b}\includegraphics[width=0.49\textwidth]{figures/lines_dc.pdf}}
...
Despite there 
\todo{talk about RMSD as motivation}
