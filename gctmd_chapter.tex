...
\begin{figure}
	...
	\subfigure[WT Run 1]{\label{fig:a}\includegraphics[width=0.49\textwidth]{wt_ss}}
	\subfigure[YD Run 1]{\label{fig:b}\includegraphics[width=0.49\textwidth]{yd_ss}}
...
\begin{figure}
	\centering     %%% not \center
	\subfigure[Distribution of \diffusion in conformer ensemble]{\label{fig:a}\includegraphics[width=0.49\textwidth]{FM_hist}}
	\subfigure[Representative structures]{\label{fig:b}\includegraphics[height=0.35\textheight]{FM_rainbows}}
	\FigureCaption{\gct{} predicted conformational ensemble}
	\label{fig:fm}
\end{figure}
...
\begin{figure}
	\centering     %%% not \center
	\subfigure[RMSD to initial frame]{\label{fig:a}\includegraphics[height=0.35\textheight]{dc_ts}}
	\subfigure[RMSD 10ns window]{\label{fig:b}\includegraphics[height=0.3\textheight]{dc_strucs}}
	\FigureCaption{Secondary structure assignments}
\end{figure}
...
\begin{figure}
\centering     %%% not \center
\subfigure[Figure A]{\label{fig:a}\includegraphics[width=0.49\textwidth]{wt_contacts}}
\subfigure[Figure B]{\label{fig:b}\includegraphics[width=0.49\textwidth]{yd_contacts}}
\subfigure[Figure C]{\label{fig:b}\includegraphics[width=0.49\textwidth]{representatives}}
\FigureCaption{Distribution of diffusion coefficients}
\end{figure}
...
\subfigure[Figure B]{\label{fig:b}\includegraphics[width=0.7\textwidth]{consensus}}
\end{figure}
...
\begin{figure}
	...
	\FigureCaption{{\bf Principal Component Analysis}}{This is the text of the PCA figure}
	\clearpage
	\label{fig:pca}
\end{figure}
