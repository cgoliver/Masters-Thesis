...
\SetAbstractFrText{De r\'ecents progr\`es dans les m\'ethodologies experimentales et informatiques de la biologie structurale d\'emontrent que la foncion des prot\'eines ne d\'epend pas uniquement sur les architectures tridimensionelles stables des prot\'eines, mais aussi sur l'absence de la structure. Les \'elements d\'epourvus de structure, aussi appel\'es prot\'eines ou r\'egions intrinsiquement d\'esordonn'es (PID, RID) sont des chaines proteine\'es qui n'adoptent pas d'architectures organis\'es mais sont toutefois fonctionelles. Gr\^ace \`a leur squelette flexible, les PID/RID, peuvent explorer une vaste gamme de conformations et fonctions. La cellule exploite cette flexibilit\'e en ciblant les RID pour des modifications post-traductionnelles (MPT) comme la phosphorylation. L'alt\'eration du balayage conformationnel des RID par les MPT est un outil pour le contr\^ole fonctionnel et l'integration des signaux cellulaires. Cet paradigme est essentiel pour assurer l'ex\'ecution correcte des processus cellulaires qui impliquent un grand nombre des proteines \rq multi-t\^aches \lq qui doivent agir de  maniere pr\'ecise et coordonn\'e. Cependant, les m\'ecanismes physiques qui \'etablissent un lien entre les RID et les r\'esultats fonctionels sont en grande partie inconnus. Ici on pr\'esente une \'etude sur le r\^ole de la phosphorylation dans l'assemblage et organisation du fuseau mitotique, la machine mol\'eculaire qui effectue la s\'egr\'egation des chromosomes durant la division cellulaire. La phosphorylation de l'acide amin\'e tyrosine 11 (Y11) dans l'\'extremit\'e carboyxle terminale (\gct) intrinsiquement d\'esordonn\'ee contr\^ole des aspects essentiels dans l'assemblage des microtubules du fuseau mitotique. La mutation de ce site pour la, acide aspartique phosphomimetique (Y11D) provoque une sensibilit\'e \`a la temp\'erature et des d\'efauts dans l'organisation des microtubules du fuseau mitotique. En utilisant des simulations informatiques dynamique mol\'eculaire et la r\'esonance magn\'etique nucl\'eaire nous montrons que les formes non-phosphoryl\'es et phosphomimetiques du \gct balayent principalement des conformations compactes et d\'esordonn\'ees. Toutefois, la mutation Y11D entreprend des mouvements collectifs vers un \'etat mineur \'etendu et aussi d\'esordonn\'e. Nous proposons que cette transition peut s\'ervir a cont\^oler la liaison des prot\'eines qui affectent la dynamique des microtubules. Ceci est la premi\'ere observation des transitions organis\'ees dans l'ensemble de structures d\'esordonn\'ees,  ce qui propose un nouveau m\'ecanisme physique de contr\^ole avec potentiel pour r\'eguler le fonctionnement cellulaire.}%
\AbstractFr%
