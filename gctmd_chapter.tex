...
\begin{figure}
	...
	\subfigure[WT Run 1]{\label{fig:a}\includegraphics[width=0.7\textwidth]{figures/wt_ss.pdf}}
	\subfigure[YD Run 1]{\label{fig:b}\includegraphics[width=0.7\textwidth]{figures/yd_ss.pdf}}
...
\begin{figure}
	...
	\subfigure[RMSD 10ns window]{\label{fig:b}\includegraphics[height=0.35\textheight]{figures/FM_rainbows.pdf}}
	\caption{Secondary structure assignments}
	\label{fig:fm}
\end{figure}
...
\begin{figure}
	\centering     %%% not \center
	\subfigure[RMSD to initial frame]{\label{fig:a}\includegraphics[height=0.49\textheight]{figures/dc_ts.pdf}}
...
\begin{figure}
\centering     %%% not \center
\subfigure[Figure A]{\label{fig:a}\includegraphics[width=0.49\textwidth]{figures/wt_contacts.pdf}}
\subfigure[Figure B]{\label{fig:b}\includegraphics[width=0.49\textwidth]{figures/yd_contacts.pdf}}
...
\subfigure[Figure B]{\label{fig:b}\includegraphics[width=0.7\textwidth]{figures/consensus.pdf}}
\end{figure}
...
\begin{figure}
\centering     %%% not \center
\subfigure[Figure A]{\label{fig:wellsa}\includegraphics[width=0.45\textwidth]{figures/wells_a.pdf}}
\subfigure[Figure B]{\label{fig:wellsb}\includegraphics[width=0.49\textwidth]{figures/wells_b.pdf}}
\label{fig:wells}
\end{figure}
