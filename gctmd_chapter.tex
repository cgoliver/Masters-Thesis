...
\begin{figure}
	\thispagestyle{empty}
	\centering     %%% not \center
	\subfigure[WT]{\label{fig:a}\includegraphics[width=0.65\textwidth]{2d_scatter_wt}}
	\subfigure[YD]{\label{fig:b}\includegraphics[width=0.65\textwidth]{2d_scatter_yd}}
	\FigureCaption{Secondary structure assignments}
	\clearpage
	\label{fig:pca}
\end{figure}
