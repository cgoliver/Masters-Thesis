...
Although we do not observe global secondary structure rearrangements by looking at \texttt{dssp}, RMSD plots point to the presence conformational rearrangements in the mutated \gct{}. RMDS quantifies the distance between structures and is therefore a useful tool for detecting the presence of conformational changes in a trajectory. 

\todo{RMSD figs}
	
{\it \gct{} is largely collapsed}

We next use radius of gyration and diffusion coefficient as quantitative measures of the compactness of the polypeptides. Such measurements can also give us some insight into the kind conformational dynamics being experienced by the mutant. Given the lack of global secondary structure, ... NMR experiments report that...
